...
class Component:
	""" component object
		...
		Explanation	explanation string to customise an explanation of component
...
class Context:
	""" context object
		Identifier	the identifier of the component
				unique in the context
		Description	readable description
		Explanation	explanation string to customise an explanation of context
...
#	    verifier = Crypto.Signature.PKCS1_PSS.new(key)
	...
	returns:
		...
		try:
			...
			return "mkcomponent: no evidence db for %s"%(self.curcontext)
		if str(componentobj.Identifier) in evdb:
			return "mkcomponent: evidence db entry for %s already present"%(componentid)
